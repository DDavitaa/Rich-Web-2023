...
// const pauseResumeClicks$ = pause_resume$.pipe(
//     rxjs.startWith(false),
//     rxjs.map(val => !val),
//     rxjs.switchMap(paused => paused ? seconds$ : rxjs.EMPTY)
// );
...
// const seconds$ = pauseResumeClicks$.pipe(
//     rxjs.switchMap(paused => 
//         paused 
//         ? rxjs.interval(1000).pipe(
//             rxjs.map(i => {
//                 elapsedTime++;
//                 return countdownTimeInSeconds - elapsedTime;
//             }),
//             rxjs.takeUntil(pauseResumeClicks$)
//         )
//         : rxjs.interval(0)
//     )
// );
